...
Каждый кто добавит изменения будет внесен в список авторов. Для начала редактирования напишите свой github логин на  **dautov2@yandex.ru ** и вам будет предоставлен доступ.
