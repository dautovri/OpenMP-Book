...
между компонентами сопроцессора.Каждый контроллер памяти включает два независимых канала доступа к памяти, при этом все контроллеры памяти сопроцессора действуют независимо друг от друга.